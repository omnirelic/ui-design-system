    ...
    return (
      <div style={{ background: CARD, padding: "12px 40px", display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: `1px solid ${BORDER}`, position: "sticky", top: 0, zIndex: 10 }}>
        ...
        <Reactive
          ...
          style={{ background: "transparent", border: `1px solid ${BORDER}`, color: DIM, padding: "7px 16px", fontSize: 11, letterSpacing: 1, cursor: "pointer", fontFamily: MONO, borderRadius: 50 }}
        >
          PARTAGER
        </Reactive>
      </div>
  ...
  return (
    <div style={{ background: CARD, padding: "12px 16px", display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: `1px solid ${BORDER}` }}>
      ...
      <Reactive
        ...
        variant="icon"
        onClick={() => shareUrl(title)}
        style={{ width: 34, height: 34, borderRadius: "50%", background: BG2, border: "none", color: DIM, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}
      >
